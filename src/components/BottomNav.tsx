...
const BottomNav = () => {
  ...
  // Handle home button click to reset filter to 'All'
  const handleHomeClick = (e: React.MouseEvent) => {
    // Only apply special behavior when we're not already on the home page
    if (location.pathname !== '/home') {
      e.preventDefault(); // Prevent default Link behavior
      // Navigate to home with state parameter to indicate filter reset
      navigate('/home', { state: { resetFilter: true } });
    }
  };
