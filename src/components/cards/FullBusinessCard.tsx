...
const FullBusinessCard = ({ card }: FullBusinessCardProps) => {
  // Determine if the background is a gradient, solid color, or image
  const backgroundStyle = useMemo(() => {
    const bg = card.design.backgroundStyle;
  ...
  }, [card.design.backgroundStyle]);
  
  return (
    <div className="m-4 p-6 rounded-xl shadow-lg" style={backgroundStyle}>
